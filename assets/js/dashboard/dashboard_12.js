...
(function () {
  ...
  var taskStatistics = new ApexCharts(
    ...
    series: [
      {
        ...
        data: [
          25, 60, 70, -35, -105, -130, -130, -115, -95, -60, 15, 45, 105, 60,
          35, 70, 105, 120, 140, 150, -20, -66, -95, -95, -60, -55, 15, 48, 105,
          60, 25, 75,
        ],
      },
    ],
  ...
  var estimatedProjectChart = new ApexCharts(
    document.querySelector("#estimated-project"),
    estimatedOptions
  );
  ...
  var monthlyExpense = new ApexCharts(
  ...
  var yearlyExpense = new ApexCharts(
    document.querySelector("#yearly-expense"),
    yearlyExpense
  );
  ...
  var projectAnalysisChart = new ApexCharts(
