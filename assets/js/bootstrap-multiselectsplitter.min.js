+(function (a) {
  ...
  (b.DEFAULTS = {
    ...
    template:
      '<div class="grid grid-cols-12" data-multiselectsplitter-wrapper-selector><div class="col-span-6 sm:col-span-12"><select class="form-control" data-multiselectsplitter-firstselect-selector></select></div> <!-- Add the extra clearfix for only the required viewport --><div class="col-span-6 sm:col-span-12"><select class="form-control" data-multiselectsplitter-secondselect-selector></select></div></div>',
  }),
