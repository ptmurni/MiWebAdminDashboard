...
function delivery_fields() {
  ...
  divtest.innerHTML =
    '<div class="grid grid-cols-12 gap-2"> <div class="col-span-6 sm:col-span-12"> <input class="form-control" id="baseItemName" type="text" name="baseItemName[]" value="" placeholder="Enter Title"> </div> <div class="col-span-6 sm:col-span-12"> <input class="form-control" id="basePrice" type="text" name="basePrice[]" value="" placeholder="Enter Description"> </div> <div class="col-12"> <div class="input-group-btn"> <button class="btn btn-danger text-white" onclick="remove_delivery_fields(' +
    room +
